$(document).ready(function(){
    ...
    //define que indice de correcao, juros, diferença e total são de somente leitura
    
    $('#indicecorrecao'+count).prop('readonly',true);
    $('#juros'+count).prop('readonly', true);    
    $('#total'+count).prop('readonly', true);
    $('#diferenca'+count).prop('readonly', true);
