                        ...
                        <!--<div align="right"><h4 id="exibir" style="margin-bottom: 1.0em; margin-right: 18em;color: red;font-weight: bold;"><h4></div>-->
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input placeholder="Monte bruto" type="text" id="montebruto" name="montebruto" class="form-control">
                                        </td>
                                        <td> 
                                            <input placeholder="Monte partilhável" type="text" id="montepartilhavel" name="montepartilhavel" class="form-control">
                                        </td>
                                    </tr>
