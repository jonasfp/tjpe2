...
$query = $pdo->prepare("INSERT INTO $tabela SET tipo =:tipo, dataevento = :dataevento,historico =:historico, quantidade = :quantidade, valor_unitario =:valor_unitario, total_extras = :total_extras");
